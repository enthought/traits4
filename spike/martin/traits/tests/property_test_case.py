...
from martin.traits.api import Any, HasTraits, Instance, Int, TraitError
from martin.traits.api import Property, Undefined
...
class PropertyTestCase(unittest.TestCase):
    ...
    def test_getter_called(self):
        ...
        f = Foo()
        self.assertEqual(f.get_count, 0)

        self.assertEqual(f.x, Undefined)
        self.assertEqual(f.get_count, 1)

        self.assertEqual(f.x, Undefined)
        self.assertEqual(f.get_count, 2)
